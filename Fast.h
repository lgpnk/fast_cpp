...
public:
    ...
    ~Fast(){}
     ...
     virtual int fast_corner_score(const uint8_t* p, const int pixel[], int t_start, bool bright);
...
//     Pixel* fast12_detect(const uint8_t* im, int xsize, int ysize, int stride, int b, int* ret_num_corners);
     ...
     virtual void fast_detect_nosup(const uint8_t* im, int xsize, int ysize, int stride, int t, int &ret_num_corners);
     
     virtual int *fast_score(const uint8_t* i, int stride, Pixel* corners, int num_corners, int b);
...
//     int* fast12_score(const uint8_t* i, int stride, Pixel* corners, int num_corners, int b);
     ...
     virtual void fast_detect_nonmax(const uint8_t* im, const int &xsize, const int &ysize, const int &stride, const int &b, int& ret_num_corners, int suppression);
